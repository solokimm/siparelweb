...
var KTApp = (function () {
	...
	var blockPage = function () {
		...
		blockUI.block();
		return blockUI; // Mengembalikan instance KTBlockUI
	};

	var unblockPage = function () {
		var blockedUI = blockPage(); // Memanggil fungsi blockPage untuk mendapatkan instance KTBlockUI
		blockedUI.release(); // Menggunakan instance untuk memanggil metode release()
	};
