	...
	<div id="kt_app_content_container" class="app-container container-fluid">
				...
				<div class="d-flex flex-wrap flex-sm-nowrap mb-3">
					<div class="me-7 mb-4">
						<div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
							...
							<input type="hidden" id="idUser" value="<?= $profile['id'] ?>">
						</div>
					</div>
						...
						<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
							<div class="d-flex flex-column">
								<div class="d-flex align-items-center">
									...
									<?= ($profile['role'] == 'superadmin') ? '<span class="mx-2 badge badge-info">Super Admin</span>' : (($profile['role'] == 'admin') ? '<span class="mx-2 badge badge-primary">Admin</span>' : '<span class="mx-2 badge badge-success">Penyuluh</span>') ?>
								</div>
								<div class="fw-semibold fs-6 text-gray-400"><?= $profile['group_name'] ?></div>
							</div>
							<?php
							if ($profile['id'] !== $this->session->userdata('id_user')) : ?>
								<div class="d-flex">
									<div class="me-0">
										<button class="btn btn-sm btn-icon btn-warning btn-active-color-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
											<i class="bi bi-three-dots fs-3"></i>
										</button>
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true">
											<div class="menu-item px-3"> <a href="javascript:void(0)" id="editUser" class="menu-link px-3">Ubah</a> </div>
											<div class="menu-item px-3"> <a href="javascript:void(0)" id="deleteUser" class="menu-link flex-stack px-3">Hapus</a> </div>
										</div>
									</div>
								</div>
							<?php endif; ?>
							...
							<div class="d-flex flex-column flex-grow-1 pe-8">
								<div class="d-flex flex-wrap">
									<div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
										<div class="d-flex align-items-center">
											<div class="fs-2 fw-bold counted" data-kt-countup="true" data-kt-countup-value="4500" data-kt-countup-prefix="$" data-kt-initialized="1"><?= $profile['total_volunteers'] ?></div>
										</div>
										<div class="fw-semibold fs-6 text-gray-400">Relawan</div>
									</div>
								</div>
							</div>
						</div>
		...
		<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
			...
			<div class="card-body p-9">
				<div class="row mb-7">
					<label class="col-lg-4 fw-semibold">NIP.</label>
					<div class="col-lg-8">: <span class="fw-bold fs-6"><?= $profile['nip'] ?></span> </div>
				</div>
				...
				<div class="row mb-7"> <label class="col-lg-4 fw-semibold">No. Telepon</label>
					<div class="col-lg-8">: <span class="fw-bold fs-6"><?= ($profile['phone']) ? $profile['phone'] : '-' ?></span></div>
				</div>
				<div class="row mb-7"> <label class="col-lg-4 fw-semibold">Alamat</label>
					<div class="col-lg-8">: <span class="fw-bold fs-6"><?= ($profile['address']) ? $profile['address'] : '-' ?></span> </div>
				</div>
			...
			<div class="card-body p-9">
				<form id="form_edit" class="form" action="javascript:void(0)">
					<div class="form-group row mb-3 fv-row fv-plugins-icon-container">
						<label for="edit_nip" class="col-md-4 col-form-label">NIP.</label>
						<div class="col-md-6">
							<input type="text" class="form-control form-control-solid active" readonly id="edit_nip">
						</div>
					</div>
					<div class="form-group row mb-3 fv-row fv-plugins-icon-container">
					...
					<div class="form-group row mb-9">
						<label for="edit_role" class="col-md-4 col-form-label">Peranan</label>
						<div class="col-md-6">
							<select class="form-select" name="edit_role" id="edit_role" data-kt-select2="true" data-placeholder="Pilih Peranan" data-allow-clear="true" data-kt-user-table-filter="two-step" data-hide-search="true">
								<option></option>
